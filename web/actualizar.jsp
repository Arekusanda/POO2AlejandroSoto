...
String q="update tblproductos set nombre='"+nombre+"', descripción='"+descripción+"', cantidad="+cantidad+", [Precio Unitario]="+precio+" where código ="+código+";";
...
out.println("EL PRODUCTO FUE MODIFICADO");
...
out.println("PRECIO UNITARIO:<INPUT TYPE=TEXT NAME=PRECIOB><BR>");
